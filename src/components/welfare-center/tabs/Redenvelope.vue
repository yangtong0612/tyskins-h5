  ...
  <div class="redenvelope-box" v-loading="loading" element-loading-background="rgba(0, 0, 0, 0.5)">
    ...
    <div class="redenvelope-content">
      <div class="redenvelope animate__animated animate__flipInY" v-if="!showRule">
        ...
        <div class="tips">加群 <span>833629110</span> 不定期发红包福利</div>
        <div class="form-item">
...
.redenvelope-box {
  ...
  .redenvelope-bg {
    ...
    width: 792px;
    height: 434px;
    background-image: url(@/assets/img/welfare/bg_redenvelopes.png);
    background-size: 100%;
  ...
  .redenvelope {
    ...
    width: 306px;
    height: 352px;
    background-image: url(@/assets/img/welfare/bg_red_envelope_cover.png);
    background-size: 100%;
    display: flex;
  ...
  .redenvelope-rule {
    ...
    // background-image: url(@/assets/img/welfare/bg_red_envelope_reverse.png);
    background-size: 100%;
    display: flex;
    flex-direction: column;
    align-items: center;
