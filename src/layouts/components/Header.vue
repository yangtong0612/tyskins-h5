<template>
  ...
  <div class="myappbar" :class="currentName == 'Home' ? 'homebg' : 'combg'">
    <div
      class="d-flex align-center pc-header justify-space-between"
        ...
        <div class="toptabs">
          ...
          >
            ...
            >
              ...
              >
                <path
                  d="M2 4h3v2H2V4zm9 0h3v2h-3V4zM2 10h3v2H2v-2zm9 0h3v2h-3v-2zM6 6h4v4H6V6z"
                  fill="currentColor"
                  stroke="currentColor"
                  stroke-width="0.5"
                />
              ...
              >
                <path
                  d="M8 0L6 2H2v2h2v8h8V4h2V2h-4L8 0zm0 4h2v2H8V4zm-4 2h8v6H4V6z"
                  fill="currentColor"
                />
              </svg>
              <svg
              ...
              >
                <path
                  d="M8 0l2 4h4v2a2 2 0 01-2 2h-2v4a2 2 0 01-2 2H6a2 2 0 01-2-2V8H2a2 2 0 01-2-2V4h4l2-4z"
                  fill="currentColor"
                />
              </svg>
              <span>{{ link.name }}</span>
            ...
            >
              ...
              >
                <div class="dropdown-item-icon">
                  ...
                  >
                    <path
                      d="M10 0l2.5 6.5L20 7.5l-5 4.5 1.5 7L10 15l-6.5 4.5L5 12l-5-4.5L7.5 6.5 10 0z"
                    />
                  </svg>
                  <svg
                    v-else-if="child.icon === 'sword'"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
                      d="M2 2l2 2v12l-2 2h2l2-2V4l-2-2H2zm16 0l-2 2v12l2 2h-2l-2-2V4l2-2h2z"
                    />
                  </svg>
                  <svg
                    v-else-if="child.icon === 'box'"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                ...
                <span
                  v-if="child.badge === 'HOT'"
                  class="dropdown-badge badge-hot"
                  >HOT</span
                >
                <span
                  v-else-if="child.badge === 'NEW'"
                  class="dropdown-badge badge-new"
                  >NEW</span
                >
              </div>
            </div>
    ...
    <div v-if="!isMobile" class="top-right-box">
      ...
      <div v-if="store.getters.userInfo" class="czbtn" @click="openCzTs()">
        <svg
          ...
          viewBox="0 0 22 22"
          class="account_depositIcon__fQGY1"
          width="22"
          height="22"
        >
          <path
      ...
      <div v-if="store.getters.userInfo" class="header-userinfo">
        <div class="mr-2" @click="goTo()">
          <v-avatar
            ...
            ><img
              class="avatar"
              :src="processImageUrl(store.state.user?.avatar)"
              alt=""
          /></v-avatar>
        </div>
        <div class="toprbox">
          ...
          <div class="d-flex a-center">
            ...
            <div
              ...
              style="color: #ff8000; margin-left: 10px"
            >
              <img
                style="width: 12px"
    ...
    <div class="mobile-header">
      ...
      <div>
        ...
        <div v-else class="d-flex">
          ...
          <v-avatar
            style="border: 1px solid #54688d; margin-right: 14px"
    ...
    >
      <div class="py-4">
        <div class="d-flex" style="align-items: flex-start">
          ...
          <p class="ml-2 fs14 text-white">
            充值即代表本人已满18周岁且具备完全行为能力并同意
            <router-link
              style="color: #f3a45d"
              @click="colseCzTs()"
              to="/service?type=1"
      ...
      <div v-if="isAgree" class="py-4">
        <v-btn
          ...
          color="#f3a45d"
        >
          <span class="text-white fs16"> 确认充值 </span>
        </v-btn>
      </div>
    </q-popup>
    <q-popup
    ...
    >
      <div>
        ...
        <v-btn
          @click="openRealNameRef"
          width="100%"
          height="40"
          elevation="0"
          color="primary"
        >
          <span class="text-white fs16"> 去认证 </span>
        </v-btn>
      </div>
    </q-popup>
  </div>
...
function isGameChildActive(link: any): boolean {
  ...
  return link.children.some(
    (child: any) => child.module === state.currentModule
  );
}
...
watch(router.currentRoute, (newRouter) => {
  ...
  if (state.currentModule !== "home" && state.currentModule !== "games") {
    const gameLink = state.links.find(
      (link) =>
        link.hasDropdown &&
        link.children?.some((child) => child.module === state.currentModule)
    );
    if (gameLink) {
  ...
  .login-btn-group {
    ...
    & > div {
      ...
      &:last-child {
        ...
        color: #503d2e;
        box-shadow: 0 2px 6px rgba(243, 164, 93, 0.4),
        ...
        &:hover {
          box-shadow: 0 3px 8px rgba(243, 164, 93, 0.5),
        ...
        &:active {
          ...
          box-shadow: 0 1px 3px rgba(243, 164, 93, 0.3),
