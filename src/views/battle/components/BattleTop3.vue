<template>
  ...
  <div v-if="topThreeScoresYesterday.length >= 3" class="top1-3">
    ...
    <div class="tc fs18 mb-3 text-white" style="font-weight: bold">
      昨日三甲
    </div>
    ...
    <div class="top1-3-list">
      <div class="item-box">
        ...
        <div class="text-box">
          <div class="nickname line1">
            {{ topThreeScoresYesterday[0]?.nickname }}
          </div>
          <div class="score">
            {{ processScore(topThreeScoresYesterday[0]?.integral) }}
          </div>
        </div>
      </div>
      <div class="item-box">
        ...
        <div class="text-box">
          <div class="nickname line1">
            {{ topThreeScoresYesterday[1]?.nickname }}
          </div>
          <div class="score">
            {{ processScore(topThreeScoresYesterday[1]?.integral) }}
          </div>
        </div>
      </div>
      <div class="item-box">
        ...
        <div class="text-box">
          <div class="nickname line1">
            {{ topThreeScoresYesterday[2]?.nickname }}
          </div>
          <div class="score">
            {{ processScore(topThreeScoresYesterday[2]?.integral) }}
          </div>
        </div>
      </div>
    </div>
