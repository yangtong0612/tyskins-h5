<template>
  <div>
      ...
      <div class="d-flex">
        ...
        <div v-if="list.length">
          ...
          <v-btn
            ...
            elevation="0"
          >
            <span class="fs14 text-white">二次存入</span>
          </v-btn>
        </div>
      </div>
    </div>
    <div>
      ...
      <div
        class="d-flex"
        style="flex-wrap: wrap; margin-right: -8px; margin-left: -8px"
      >
        <!-- width:25%; -->
        <div
            ...
            <shop-item :item="item" :rarity="false">
              ...
              <template #btns>
                <div class="d-flex mt-2">
                  ...
                  <v-btn
                    style="border-radius: 10px; margin-left: 2px"
